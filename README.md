...
创建了类Chess,使用3x3的int类型矩阵表示棋盘，值为1代表1号选手，2代表2号选手，0代表未下，如第一行乘积为1则代表1赢，8代表2赢，通过函数display将数组转换为Image图像返回
...
![Tic-Tac-Toe](https://github.com/ruxia-TJY/Tic-Tac-Toe/raw/main/res/img.png)
